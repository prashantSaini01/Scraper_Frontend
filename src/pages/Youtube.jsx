...
//               <th className="px-4 py-3 border-b border-gray-600">Thumbnail</th>
...
//                 Description
//               </th>
//               <th className="px-4 py-3 border-b border-gray-600">Video URL</th>
//             </tr>
//           </thead>
//           <tbody>
...
//           className="w-full p-4 text-lg border-2 border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 bg-gray-900 text-white"
//         />
//         <input
//           type="number"
//           value={maxResults}
...
//           className="w-full mt-6 px-6 py-3 bg-gradient-to-r from-red-600 to-yellow-500 text-white rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-transform duration-300"
//           disabled={loading}
//         >
...
//       {/* YouTube Data Icons */}
//       <div className="flex space-x-6 mt-6 mb-6 text-white">
//         <div className="flex flex-col items-center">
//           <FontAwesomeIcon icon={faImage} className="text-3xl text-blue-600" />
//           <span className="mt-2 text-sm">Thumbnail</span>
//         </div>
//         <div className="flex flex-col items-center">
//           <FontAwesomeIcon icon={faVideo} className="text-3xl text-blue-600" />
//           <span className="mt-2 text-sm">Video Title</span>
//         </div>
//         <div className="flex flex-col items-center">
...
//           />
//           <span className="mt-2 text-sm">Date Posted</span>
//         </div>
//         <div className="flex flex-col items-center">
//           <FontAwesomeIcon
//             icon={faAlignLeft}
...
//           <span className="mt-2 text-sm">Video URL</span>
//         </div>
//       </div>
